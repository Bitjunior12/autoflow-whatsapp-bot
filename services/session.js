...
async function setSession(phone, data) {
  ...
  } catch (err) { console.error('❌ Erreur setSession :', err.message); }
}
...
async function getSession(phone) {
  ...
  } catch (err) { console.error('❌ Erreur getSession :', err.message); return null; }
}
...
async function clearSession(phone) {
  ...
  } catch (err) { console.error('❌ Erreur clearSession :', err.message); }
}
